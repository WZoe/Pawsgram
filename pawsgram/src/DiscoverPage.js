            ...
            return (
                <li className="post row" key={index}>
                    <div className="postTimeline col-3">
                        ...
                        <Like likePlus={this.likePlus} index={index} event_id={event._id}/>
                        }
                    </div>
                    <div className="col-auto postContent rounded align-self-center color-light" onClick={() => {
                        ...
                        <div className="photos">
                            <div className="photo m-1 rounded"><img className="rounded"
                                                                    src={process.env.PUBLIC_URL + '/img/' + event.photo[0]}
                                                                    alt=""/></div>
                            <div className="photo m-1 rounded"><img className="rounded"
                                                                    src={process.env.PUBLIC_URL + '/img/' + event.photo[1]}
                                                                    alt=""/></div>
                            <div className="photo m-1 rounded"><img className="rounded"
                                                                    src={process.env.PUBLIC_URL + '/img/' + event.photo[2]}
                                                                    alt=""/></div>
                            <div className="photo m-1 rounded"><img className="rounded"
                                                                    src={process.env.PUBLIC_URL + '/img/' + event.photo[2]}
                                                                    alt=""/></div>

                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-body" id="signUpBody">
                            ...
                            <div className="form-group">
                                ...
                                <input className="form-control" type="text" name="pet_name" value={this.state.pet_name} onChange={this.handleChange}/>
                            </div>
                            <div className="form-group">
                                <label >Breed</label>
                                <input className="form-control" type="text" id="breed" name="breed" value={this.state.breed} onChange={this.handleChange}/>
                            </div>
                            <div className="form-group">
                                <label >Color</label>
                                <input className="form-control" type="text" id="color" name="color" value={this.state.color} onChange={this.handleChange}/>
                            </div>
                            <div className="form-group">
                            ...
                            <div className="form-group">
                                ...
                                <input className="form-chek-input mr-2" type="radio" id="gender" name="gender" value="male" onChange={this.handleChange}/><label className="form-check-label mr-3"><i className="fas fa-mars"></i></label>
                                <input className="form-chek-input mr-2" type="radio" id="gender" name="gender" value="female" onChange={this.handleChange}/><label
                        ...
                        <div className="modal-footer">
                            <button type="button" className="btn btn-primary" id="signUpSubmit"  data-dismiss="modal" data-target="#signUp" onClick={()=>{this.props.userSignUp(this.state)}}>Sign Up</button>
                        </div>
                    </div>
                </div>
            </div>
